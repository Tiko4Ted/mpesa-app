...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, Image, TouchableOpacity, RefreshControl, useColorScheme, NativeScrollEvent, NativeSyntheticEvent } from 'react-native';
